...
function displayTransactions(){
  ...
  for(let i = 0; i < transactions.length; i++){
    ...
    console.log(`Description: ${transaction.description}, Type: ${transaction.type}, Amount: $${transaction.amount}, Balance: $${balance}, ${transaction}`);
  }
}
...
function promptForNewTransaction(){
  ...
  console.log(`Transaction added successfully! Current balance is: $${balance}.`);
}
...
function promptForDeleteTransaction(){
  ...
  const index = prompt("Enter the index of the transaction to delete:");
  deleteTransaction(index);
  console.log(`Transaction at index ${index} deleted successfully! Current balance is: $${balance}.`);
}
